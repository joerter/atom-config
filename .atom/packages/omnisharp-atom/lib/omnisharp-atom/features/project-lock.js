...
var FileMonitor = (function () {
    ...
    FileMonitor.prototype.activate = function () {
        ...
        var pauser = rx_1.Observable.merge(projectJsonEditors.throttleFirst(10000), Omni.listener.packageRestoreFinished.debounce(1000).map(function (z) { return true; })).startWith(true);
        ...
        this.disposable.add(changes
            .buffer(changes.throttleFirst(1000), function () { return rx_1.Observable.timer(1000); })

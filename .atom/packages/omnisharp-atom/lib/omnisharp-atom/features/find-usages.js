...
var FindUsages = (function () {
    ...
    FindUsages.prototype.activate = function () {
        ...
        this.observe = {
            ...
            open: Omni.listener.requests.where(function (z) { return z.command === "findusages"; }).map(function () { return true; }),
            reset: Omni.listener.requests.where(function (z) { return z.command === "findimplementations" || z.command === "findusages"; }).map(function () { return true; }),
            updated: updated
        };
        this.disposable.add(Omni.addTextEditorCommand("omnisharp-atom:find-usages", function () {
            Omni.request(function (client) { return client.findusages(client.makeRequest()); });
        }));
        this.disposable.add(Omni.addTextEditorCommand("omnisharp-atom:go-to-implementation", function () {
            Omni.request(function (client) { return client.findimplementations(client.makeRequest()); });
        }));

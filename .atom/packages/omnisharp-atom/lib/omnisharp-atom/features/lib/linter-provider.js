...
exports.provider = [
    {
        ...
        lint: function (editor) {
            return Omni.request(editor, function (client) { return client.codecheck(client.makeRequest(editor)); })
                .flatMap(function (x) { return rx_1.Observable.from(x.QuickFixes); })
